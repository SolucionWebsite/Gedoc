...
namespace Gedoc.Alertas.Models
{
    public class RequerimientoModel
    {
        ...
        public List<int> TipoAdjunto { get; set; }
        public string TipoAdjuntoTitulos { get; set; }
        public List<int> Soporte { get; set; }
        ...
        public List<int> MonumentoNacionalRegion { get; set; }
        public List<int> MonumentoNacionalProvincia { get; set; }
        public List<int> MonumentoNacionalComuna { get; set; }
