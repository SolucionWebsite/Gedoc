    ...
    MagicSearch.prototype = {
        ...
        searchData: function searchData(isAll, isScroll) {
            ...
            if (isAll) {
                ...
                //search match data
                // Se buscan los elementos q empiecen con el texto de búsqueda ingresado, para q aparezcan 
                // de primeros en la lista de búsqueda
                for (var _j99 = 0; _j99 < options.fields.length; _j99++) {
                    // Elementos q empiezan con el texto de búsqueda ingresado
                    var itemsStartWith = dataJson.filter(function (item) { return item[options.fields[_j99]].toLowerCase().startsWith(inputVal.toLowerCase()) });
                    data = itemsStartWith;
                }
                for (var _i4 = 0; _i4 < dataJson.length; _i4++) {
                    ...
                    if (data.findIndex(function (item) { return item[options.id] === dataJson[_i4][options.id] }) != -1)
                        continue;
        ...
        showSearchBox: function showSearchBox(callback) {
            ...
            // Evitar cierre de la caja de búsqueda cuando se da clic en la barra de scroll cuando el control está en una ventana modal de Sharepoint:
            $magicsearch_box.mousedown(function () { return false; });
